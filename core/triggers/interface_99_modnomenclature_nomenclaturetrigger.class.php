...
class Interfacenomenclaturetrigger
{
	...
	private function _setPrice(&$PDOdb, &$object, $fk_parent, $object_type) {
		...
		if ($object_type == 'commande') {
			...
			$facture->updateline($object->id, $object->desc, $n->totalPRC_fruidoraix, $object->qty, $object->remise_percent, $object->date_start, $object->date_end, $object->txtva, $object->txlocaltax1, $object->txlocaltax2, 'HT', 0, Facture::TYPE_STANDARD, 0, 0, $object->fk_fournprice, $n->totalPRC_fruidoraix);
		}
	}
